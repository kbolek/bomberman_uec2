...
// Command     : write_verilog -force -mode synth_stub -rename_top Main_System_v_axi4s_vid_out_0_0 -prefix
//               Main_System_v_axi4s_vid_out_0_0_ video_subsystem_v_axi4s_vid_out_0_0_stub.v
...
module Main_System_v_axi4s_vid_out_0_0(aclk, aclken, aresetn, s_axis_video_tdata, 
...
/* synthesis syn_black_box black_box_pad_pin="aclk,aclken,aresetn,s_axis_video_tdata[47:0],s_axis_video_tvalid,s_axis_video_tready,s_axis_video_tuser,s_axis_video_tlast,fid,vid_io_out_ce,vid_active_video,vid_vsync,vid_hsync,vid_vblank,vid_hblank,vid_field_id,vid_data[23:0],vtg_vsync,vtg_hsync,vtg_vblank,vtg_hblank,vtg_active_video,vtg_field_id,vtg_ce,locked,overflow,underflow,fifo_read_level[10:0],status[31:0]" */;
  input aclk;
  input aclken;
  input aresetn;
