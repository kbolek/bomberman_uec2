...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/sarcasmisthere/Desktop/uec2project/repo/PROJEKT 1.0/bomberman_uec2/MicroblazeProject/MicroblazeProject.cache/compile_simlib/riviera"
  fi
