...
#
# Generated by export_simulation on Fri Aug 07 17:45:19 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './BLOCK_GPU_0.sh' script.

./BLOCK_GPU_0.sh -reset_run
...
./BLOCK_GPU_0.sh -noclean_files

For more information on the script, please type './BLOCK_GPU_0.sh -help'.
