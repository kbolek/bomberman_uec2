...
#
# Generated by export_simulation on Sun Aug 09 13:07:33 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './GPU_DC_0.sh' script.

./GPU_DC_0.sh -reset_run
...
./GPU_DC_0.sh -noclean_files

For more information on the script, please type './GPU_DC_0.sh -help'.
